...
__global__ void kernel(int * arr, uint64_t * dummy) {
  ...
  asm volatile(
		 ...
		 [in11]"v"((uint64_t *)&arr[33]), [in13]"v"((uint64_t *)&arr[65]), [in15]"v"((uint64_t *)&arr[97]), [in17]"v"((uint64_t *)&arr[128]), [in19]"v"((uint64_t *)&arr[2]), 
     [in21]"v"((uint64_t *)&arr[34]), [in23]"v"((uint64_t *)&arr[66]), [in25]"v"((uint64_t *)&arr[98])
               :"memory"
               );
