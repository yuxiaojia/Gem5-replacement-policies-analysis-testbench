...
// you will observe: m, m, m, m, h, m, m, h, h, m, h
...
__global__ void kernel(int * arr, uint64_t * dummy) {
  ...
  asm volatile(
		 ...
		 [in11]"v"((uint64_t *)&arr[128]), [in13]"v"((uint64_t *)&arr[160]), [in15]"v"((uint64_t *)&arr[33]), [in17]"v"((uint64_t *)&arr[66]), [in19]"v"((uint64_t *)&arr[1]), [in21]"v"((uint64_t *)&arr[34])
               :"memory"
               );
