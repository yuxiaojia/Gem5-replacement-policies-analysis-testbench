...
__global__ void kernel(int * arr, uint64_t * dummy) {
  ...
  asm volatile(
		 ...
		 [in11]"v"((uint64_t *)&arr[160]), [in13]"v"((uint64_t *)&arr[192]), [in15]"v"((uint64_t *)&arr[224]), [in17]"v"((uint64_t *)&arr[1]), [in19]"v"((uint64_t *)&arr[33]), 
     [in21]"v"((uint64_t *)&arr[65]), [in23]"v"((uint64_t *)&arr[97]), [in25]"v"((uint64_t *)&arr[2]), [in27]"v"((uint64_t *)&arr[129]), [in29]"v"((uint64_t *)&arr[34])
               :"memory"
               );
