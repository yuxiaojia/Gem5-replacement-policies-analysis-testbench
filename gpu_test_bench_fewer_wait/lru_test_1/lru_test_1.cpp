...
__global__ void kernel(int * arr, uint64_t * dummy) {
  ...
  asm volatile(
	       ...
	       "buffer_wbinvl1\n\t"
               ...
               "s_waitcnt vmcnt(0) & lgkmcnt(0)\n\t"
               "s_nop 0\n\t"
               : [out0]"=v"(a), [out2]"=v"(b), [out4]"=v"(c), [out6]"=v"(d), [out8]"=v"(e), [out10]"=v"(f), [out12]"=v"(g), [out14]"=v"(h), [out16]"=v"(i), [out18]"=v"(j), [out20]"=v"(k), [out22]"=v"(l), [out24]"=v"(m), [out26]"=v"(n), [out28]"=v"(o), [out30]"=v"(p)
	       : [in1]"v"((uint64_t *)&arr[0]), [in3]"v"((uint64_t *)&arr[32]), [in5]"v"((uint64_t *)&arr[64]), [in7]"v"((uint64_t *)&arr[96]), [in9]"v"((uint64_t *)&arr[1]),
		 [in11]"v"((uint64_t *)&arr[33]), [in13]"v"((uint64_t *)&arr[128]), [in15]"v"((uint64_t *)&arr[160]), [in17]"v"((uint64_t *)&arr[192]), [in19]"v"((uint64_t *)&arr[224]), 
     [in21]"v"((uint64_t *)&arr[2]), [in23]"v"((uint64_t *)&arr[34]), [in25]"v"((uint64_t *)&arr[129]), [in27]"v"((uint64_t *)&arr[161]), [in29]"v"((uint64_t *)&arr[193]), [in31]"v"((uint64_t *)&arr[225])
               :"memory"
               );
