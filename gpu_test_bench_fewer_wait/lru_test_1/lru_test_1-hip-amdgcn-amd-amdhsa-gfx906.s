...
; %bb.0:
	...
	s_addc_u32 s3, s1, 0
	s_add_u32 s6, s0, 0x200
	s_addc_u32 s7, s1, 0
	s_add_u32 s8, s0, 0x280
	s_addc_u32 s9, s1, 0
	s_add_u32 s10, s0, 0x300
	s_addc_u32 s11, s1, 0
	s_add_u32 s12, s0, 0x380
	s_addc_u32 s13, s1, 0
	s_add_u32 s14, s0, 8
	s_addc_u32 s15, s1, 0
	s_add_u32 s16, s0, 0x88
	s_addc_u32 s17, s1, 0
	s_add_u32 s18, s0, 0x204
	s_addc_u32 s19, s1, 0
	s_add_u32 s20, s0, 0x284
	s_addc_u32 s21, s1, 0
	s_add_u32 s22, s0, 0x304
	s_addc_u32 s23, s1, 0
	v_mov_b32_e32 v0, s0
	v_mov_b32_e32 v1, s1
	s_add_u32 s0, s0, 0x384
	s_addc_u32 s1, s1, 0
	v_mov_b32_e32 v9, s5
