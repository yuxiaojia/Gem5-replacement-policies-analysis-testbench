...
__global__ void kernel(int * arr, uint64_t * dummy) {
  ...
  uint64_t a = 0, b = 0, c = 0, d = 0, e = 0, f = 0, g = 0, h = 0, i = 0, j = 0, k = 0, l = 0, m = 0, n = 0;
  asm volatile(
	       ...
	       "buffer_wbinvl1\n\t"
               ...
               "s_nop 0\n\t"
               : [out0]"=v"(a), [out2]"=v"(b), [out4]"=v"(c), [out6]"=v"(d), [out8]"=v"(e), [out10]"=v"(f), [out12]"=v"(g), [out14]"=v"(h), [out16]"=v"(i), [out18]"=v"(j), [out20]"=v"(k), [out22]"=v"(l), [out24]"=v"(m), [out26]"=v"(n)
     ...
     [in21]"v"((uint64_t *)&arr[65]), [in23]"v"((uint64_t *)&arr[97]), [in25]"v"((uint64_t *)&arr[66]), [in27]"v"((uint64_t *)&arr[98])
               :"memory"
               );
